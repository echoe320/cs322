...
namespace L2{
  ...
  // Reg Lists
  // extern int caller_reg_list[9]; // = {reg::r10, reg::r11, reg::r8, reg::r9, reg::rax, reg::rcx, reg::rdi, reg::rdx, reg::rsi};
  // extern int callee_reg_list[6] = {reg::r12, reg::r13, reg::r14, reg::r15, reg::rbp, reg::rbx};
  // extern int arg_reg_list[6] = {reg::rdi, reg::rsi, reg::rdx, reg::rcx, reg::r8, reg::r9};
